...
AI_BASE_URL = "https://iamsuperstar" # 或 https://api.openai.com/v1
...
# --- 百度网盘 OpenAPI 配置 ---
BAIDU_APP_KEY = "ihatebaidunetdisk"
BAIDU_SECRET_KEY = "114514aaaaaaaaaaaaaaa"
...
BAIDU_AUTH_CODE = "xuzhouchennaizhongyuandiyixiongguan"

BAIDU_TARGET_DIR = "/coc" # 指定的搜索目录
...
# --- 核心处理任务 ---
def background_process(job_id, key, password, source, is_pro=False, is_kind=False, mode='analyze', persona="", custom_prompt="", theme='default'):
...
def submit_task():
    ...
    executor.submit(background_process, job_id, key, password, source, is_pro, is_kind, mode, persona, custom_prompt, theme)
    return jsonify({'status': 'ok', 'id': job_id})
